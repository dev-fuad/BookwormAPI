...
router.get("/search", (req, res) => {
  request
    .get(
      `https://www.goodreads.com/search/index.xml?key=Bp5QYDKGFo5eem6AYPQInQ&q=${
        req.query.q
      }`
    )
    .then(result =>
...
router.get("/fetchPages", (req, res) => {
  request
    .get(
      `https://www.goodreads.com/book/show.xml?key=Bp5QYDKGFo5eem6AYPQInQ&id=${
        req.query.goodreadsId
      }`
    )
    .then(result =>
      parseString(result, (err, goodreadsResult) => {
